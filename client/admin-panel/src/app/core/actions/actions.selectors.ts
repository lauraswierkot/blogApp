...
export const selectActionState = (action: Action) =>
  createSelector(selectActionsState, (actions) => {
    const actionName = getActionName(action.type);
    return actions[actionName];
  });

export const selectActionPending = (action: Action) =>
  createSelector(selectActionsState, (actions) => {
    const actionName = getActionName(action.type);
    return actions[actionName]?.pending ?? undefined;
  });

export const selectActionErrorState = (action: Action) =>
  createSelector(
    selectActionsState,
...
export const selectActionsPending = (actions: Action[]) =>
  createSelector(
    selectActionsState,
